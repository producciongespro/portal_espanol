...
-- Tiempo de generación: 21-01-2020 a las 09:46:58
...
CREATE TABLE `articulos` (
  ...
  `url_img` varchar(25) DEFAULT NULL,
  `url_ref` varchar(128) DEFAULT NULL
...
(1, 'programas', 'Programa de estudio de Español, I Ciclo', 'img/iconos/progrma1.png', 'https://www.mep.go.cr/sites/default/files/programadeestudio/programas/espanol1ciclo.pdf'),
...
(40, 'videoconferencias', 'Videoconferencia Lanzamiento de recuersos GESPRO (Cuenticos)', 'img/iconos/videoc_11.png', 'http://videoteca.mep.go.cr/userportal/video?v=R51b6ed1ab27f4cbab903fa34d24ae325'),
